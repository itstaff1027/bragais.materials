...
class MonthlyDeliveredExport implements FromView, ShouldAutoSize, WithStyles
{
    // FILTERS - SEARCH
    public $filter_date;
    ...
    public function view(): View
    {
        ...
        $test =0;
        return view('export.products.monthly-delivered', compact('today', 'quantitiesUS', 'quantitiesEURO', 'totalQuantity'));
    }
