...
class MaterialLogs extends Component
{
    ...
    public function render()
    {
        return view('livewire.packaging.material-logs', [
            ...
            ->select('packaging_material_logs.stocks', 'packaging_materials.name', 'packaging_materials.size as material_size', 'packaging_material_logs.id as material_logs_id',
                'products.model', 'products.color', 'products.size', 'products.heel_height', 'products.category', 'packaging_material_logs.product_id')
            ->groupBy('packaging_material_logs.stocks', 'packaging_materials.name', 'material_size', 'material_logs_id', 'products.model', 'products.color', 'products.size', 'products.heel_height', 'products.category', 'packaging_material_logs.product_id')
