...
#[Title('Sponsorships')]
class Sponsorhip extends Component
{
    use WithPagination;
    ...
    {
        return Excel::download(new SponsorshipExport($this->filter_date), "OUTGOING_SPONSORSHIP_{$this->getDate()}.xlsx");
    }
    ...
    public function render(){
        ...
        return view('livewire.products.sponsorhip', [
