<div x-data="{ open: false }">
    ...
    <table class="table-auto w-full text-center divide-y-2 border-2 ">
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td  class=" border-2 ">Total Quantity: {{ $totalQuantityOnlineUS }}</td>
    ...
    <table class="table-auto w-full text-center divide-y-2 border-2 ">
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td  class=" border-2 ">Total Quantity: {{ $totalQuantityOnlineEURO }}</td>
    ...
    <table class="table-auto w-full text-center divide-y-2 border-2 ">
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td  class=" border-2 ">Total Quantity: {{ $totalQuantityStoreUS }}</td>
